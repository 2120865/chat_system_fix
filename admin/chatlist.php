<div class="col-lg-12">
	...
	<table width="100%" class="table table-striped table-bordered table-hover" id="chatRoom">
		...
		<?php
			...
			?>
			<tr>
				<td><span class="glyphicon glyphicon-user"></span><span class="badge"><?php echo mysqli_num_rows($num); ?></span> <input type="hidden" id="name<?php echo $row['chatroomid']; ?>" value="<?php echo htmlspecialchars($row['chat_name']); ?>"><?php echo htmlspecialchars($row['chat_name']); ?></td>
