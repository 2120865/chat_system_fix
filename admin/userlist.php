<div class="col-lg-12">
	...
	<table width="100%" class="table table-striped table-bordered table-hover" id="userList">
		...
		<?php
			...
			?>
			<tr>
				<td><input type="hidden" id="ename<?php echo $row['userid']; ?>" value="<?php echo htmlspecialchars($row['uname']); ?>"><?php echo htmlspecialchars($row['uname']); ?></td>
				<td><input type="hidden" id="eusername<?php echo $row['userid']; ?>" value="<?php echo htmlspecialchars($row['username']); ?>"><?php echo htmlspecialchars($row['username']); ?></td>
